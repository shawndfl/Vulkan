...
/**********************************************************************/
void ImagePipeline::initialize() {
	LOGI("initializing image");
...
/**********************************************************************/
void ImagePipeline::update(float dt) {
	
}

/**********************************************************************/
VkShaderModule ImagePipeline::createShaderModule(const std::vector<char>& code) {
...
/**********************************************************************/
void ImagePipeline::createGraphicsPipeline() {
    const Application& app = Application::get();
    ...
    pipelineInfo.renderPass = app.getStandardRenderPass();
...
/**********************************************************************/
void ImagePipeline::createDescriptorSetLayout() {
    const Application& app = Application::get();
    VkDevice device = app.getDevice();
